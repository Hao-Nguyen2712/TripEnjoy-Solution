...
{
    /// <inheritdoc />
    public partial class UpdatePropertyRelationship : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PartnerId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PropertyTypeId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    ...
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    AverageRating = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_Partners_PartnerId",
