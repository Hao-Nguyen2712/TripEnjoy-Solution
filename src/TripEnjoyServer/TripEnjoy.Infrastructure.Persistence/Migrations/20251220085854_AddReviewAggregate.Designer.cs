...
namespace TripEnjoy.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20251220085854_AddReviewAggregate")]
    partial class AddReviewAggregate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripEnjoy.Domain.Account.Entities.Settlement", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WalletId", "PeriodStart", "PeriodEnd");

                    b.ToTable("Settlements", (string)null);
                });

            modelBuilder.Entity("TripEnjoy.Domain.Account.Entities.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TripEnjoy.Domain.Account.Entities.Settlement", b =>
                {
                    b.HasOne("TripEnjoy.Domain.Account.Entities.Wallet", "Wallet")
